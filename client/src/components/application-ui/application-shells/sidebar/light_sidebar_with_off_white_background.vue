            ...
            <DialogPanel class="relative mr-16 flex w-full max-w-xs flex-1">
              ...
              <div class="flex grow flex-col gap-y-5 overflow-y-auto bg-white px-6 pb-2">
                <div class="flex h-16 shrink-0 items-center">
                  <img class="h-full pt-3 w-auto" src="https://busanforeignschool.org/wp-content/uploads/2024/01/bfs-logo_dark-blue-red-1200x1200.png" alt="BFS" />
                </div>
...
const navigation = [
  ...
  { name: 'Schedule', href: '#', icon: AcademicCapIcon, current: false },
  { name: 'Grades', href: '#', icon: StarIcon, current: false },

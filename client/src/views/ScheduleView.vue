...
export default {
  ...
  data() {
    return {
      days: [
        { id: 1, name: 'Monday', date: 'May 20, 2024' },
        { id: 2, name: 'Tuesday', date: 'May 21, 2024' },
        { id: 3, name: 'Wednesday', date: 'May 22, 2024' },
        { id: 4, name: 'Thursday', date: 'May 23, 2024', },
        { id: 5, name: 'Friday', date: 'May 24, 2024' },
      ],
      selectedDay: null,
      classes: [
        {
